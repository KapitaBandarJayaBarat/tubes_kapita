...
<head>
    ...
    <title>Admin Bandar Jaya Barat | @yield('title')</title>
...
<body>
    <script src="{{ asset('mazzer/static/js/initTheme.js') }}"></script>
    <div id="app">
        <div id="sidebar">
    ...
    <footer>
        <div class="footer clearfix mx-4 text-muted">
            <div class="float-end">
                <p>2023 &copy; Kelurahan Bandar Jaya Barat 2023</p>
            </div>
        </div>
    </footer>
    ...
    <script src="{{ asset('mazzer/compiled/js/app.js') }}"></script>
...
<script src="{{ asset('mazzer/static/js/pages/date.js') }}"></script>
