        ...
        <div class="col-12">
          <div class="card">
            ...
            <div class="card-content">
              <div class="card-body">
                <form id="myForm" class="form" data-parsley-validate action="{{route('admin.event.store') }}" method="POST" enctype="multipart/form-data">
                  @csrf
                    <div class="row">
                        <div class="col-md-12 col-12">
                            <div class="form-group mandatory @error('nama_event') is-invalid @enderror">
                                <label for="nama_event" class="form-label">Nama Event</label>
                                <input type="text" id="nama_event-column" class="form-control @error('nama_event') is-invalid @enderror" placeholder="Masukkan Nama Event" name="nama_event" value="{{ old('nama_event') }}" required>
                                @error('nama_event')
