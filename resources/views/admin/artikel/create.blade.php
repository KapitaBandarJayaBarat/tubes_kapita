        ...
        <div class="col-12">
          <div class="card">
            ...
            <div class="card-content">
              <div class="card-body">
                <form id="myForm" class="form" data-parsley-validate action="{{route('admin.artikel.store') }}" method="POST" enctype="multipart/form-data">
                  @csrf
                    <div class="row">
                        <div class="col-md-12 col-12">
                            <div class="form-group mandatory @error('judul') is-invalid @enderror">
                                <label for="judul" class="form-label">Judul</label>
                                <input type="text" id="judul-column" class="form-control @error('judul') is-invalid @enderror" placeholder="Masukkan Judul" name="judul" value="{{ old('judul') }}" required>
                                @error('judul')
                    ...
                    <div class="row">
                        <div class="col-md-12 col-12">
                            <div class="form-group mandatory @error('tgl_for_set') is-invalid @enderror">
                                <label for="tgl_for_set" class="form-label">Tanggal Publish</label>
                                <input type="datetime-local" id="tgl_for_set-column" class="form-control @error('tgl_for_set') is-invalid @enderror" placeholder="Pilih Tanggal Berapa Artikel Akan di Publish" name="tgl_for_set" value="{{ old('tgl_for_set') }}" min="{{ now()->format('Y-m-d\TH:i') }}" required>
                                @error('tgl')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
